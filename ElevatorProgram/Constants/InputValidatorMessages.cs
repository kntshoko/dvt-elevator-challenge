...
namespace ElevatorProgram.Constants
{
    public class InputValidatorMessages
    {
        ...
        public const string invalidBuildingMessage = "Number of Floors invalid, Input must be Between 2 and ";
        ...
        public const string invalidSimulationOptions = "Input is not valid, Please enter a number 1";
    }
